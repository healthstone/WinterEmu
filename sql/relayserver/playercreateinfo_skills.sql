DROP TABLE IF EXISTS relay_server.playercreateinfo_skills;

CREATE TABLE relay_server.playercreateinfo_skills
(
    racemask  smallint NOT NULL,
...
INSERT INTO relay_server.playercreateinfo_skills (racemask, classmask, skill, rank, comment)
VALUES (0, 0, 95, 0, 'Defense'),
       (0, 0, 162, 0, 'Unarmed'),
